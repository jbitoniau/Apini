...
GraphDataPresenter.render = function(canvas, graphData, graphDataWindow, graphOptions) {
	...
	if (graphOptions.getPrimaryLinesTextX || graphOptions.getPrimaryLinesTextY) {
		...
		if (graphOptions.getPrimaryLinesSpacingX) {
			GraphDataPresenter.drawLinesX(
				context,
				canvas,
				graphDataWindow,
				graphOptions.getPrimaryLinesSpacingX,
				graphOptions.getPrimaryLinesTextX,
				numMaxLinesX
			);
		}
		if (graphOptions.getPrimaryLinesSpacingY) {
			GraphDataPresenter.drawLinesY(
				context,
				canvas,
				graphDataWindow,
				graphOptions.getPrimaryLinesSpacingY,
				graphOptions.getPrimaryLinesTextY,
				numMaxLinesY
			);
		}
	}
